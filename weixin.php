  ...
  class weixin {
    ...
    public static function responseInstructions($postObj){
        if ($postObj->Content=='使用手册') {
            ...
            $MsgType='news';
            $Title='复读姬使用手册';
            $Description='教你如何食用该公众号';
            $PicUrl='https://mmbiz.qpic.cn/mmbiz_jpg/NtzSic72E5kBeDjrYNibGrkjMFclTRkXFPkJealBic5CRTcpKgUibIz5KNgjq23GcfprKOGKE0s1soKXIoekDrQnAw/0?wx_fmt=jpeg';
            $Url='https://mp.weixin.qq.com/s/enG_ZQMHyNQREqBo3OWEGQ';
